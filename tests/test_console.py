...
class TestConsole(unittest.TestCase):
    ...
    def test_docstrings_in_console(self):
        ...
        self.assertIsNotNone(console._doc_)
        ...
        self.assertIsNotNone(HBNBCommand.count._doc_)
        self.assertIsNotNone(HBNBCommand.strip_clean._doc_)
        self.assertIsNotNone(HBNBCommand.default._doc_)
