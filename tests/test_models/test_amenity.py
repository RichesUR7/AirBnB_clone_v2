...
class TestAmenity(unittest.TestCase):
    ...
    def test_attributes_Amenity(self):
        ...
        self.assertTrue('id' in self.amenity._dict_)
        self.assertTrue('created_at' in self.amenity._dict_)
        self.assertTrue('updated_at' in self.amenity._dict_)
        self.assertTrue('name' in self.amenity._dict_)

    def test_is_subclass_Amenity(self):
        """test if Amenity is subclass of Basemodel"""
        self.assertTrue(issubclass(self.amenity._class_, BaseModel), True)
